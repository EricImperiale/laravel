...
@section('title', 'Eliminar Garante :: ' . $garante->nombreCompleto)
        ...
        <header>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Eliminar Garante</li>
                </ol>
            </nav>

            <h2>Vas a eliminar a: <b>{{ $garante->nombreCompleto }}</b> con DNI <b>{{ $garante->dni }}</b></h2>
        </header>

        <form action="{{ route('garantes.processDelete', ['id' => $garante->garante_id]) }}" method="post"
              id="propietarios-delete-form">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" id="altura" name="altura" class="form-control" disabled
                       value="{{ old('altura', $garante->altura) }}">
            </div>
                ...
                <div class="col-8">
                    <div class="mb-3">
                        ...
                        <input type="text" id="numero_de_telefono" name="numero_de_telefono" class="form-control"
                               disabled value="{{ old('numero_de_telefono', $garante->numero_de_telefono) }}">
                        <div class="form-text">Sin puntos, comas y guiones.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                <button type="submit" id="btn-propietario-eliminar" class="btn btn-outline-danger w-100">Eliminar Garante</button>
            </div>
        </form>
    </section>
@endsection
