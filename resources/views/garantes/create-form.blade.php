...
@section('main')
    <section>
        <header>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Crear Garante</li>
                </ol>
            </nav>
        ...
        <form action="{{ route('garantes.processCreate') }}" method="post">
            @csrf
            ...
            <div class="mb-3">
                <button type="submit" class="btn btn-primary w-100">Crear Garante</button>
            </div>
        </form>
    </section>
@endsection
