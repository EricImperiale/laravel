<?php
/** @var \App\Models\Garante[]|\Illuminate\Database\Eloquent\Collection $garante */
/** @var \App\Models\PrefijoTelefonico[]|\Illuminate\Database\Eloquent\Collection $prefijosTelefonicos */
?>
@extends('app')

@section('title', 'Editar Garante :: ' . $garante->nombreCompleto)
    ...
    <section>
        <header>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('garantes.index') }}">Garantes</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Editar Garante</li>
                </ol>
            </nav>

            <h2>Estás editando a: <b>{{ $garante->nombreCompleto }}</b> con DNI <b>{{ $garante->dni }}</b></h2>
        </header>

        <form action="{{ route('garantes.processUpdate', ['id' => $garante->garante_id]) }}" method="post">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control"
                       value="{{ old('nombre') ?? $garante->nombre }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="apellido" name="apellido" class="form-control"
                       value="{{ old('apellido') ?? $garante->apellido }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="direccion" name="direccion" class="form-control"
                       value="{{ old('direccion') ?? $garante->direccion }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="altura" name="altura" class="form-control"
                       value="{{ old('altura') ?? $garante->direccion }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="cuidad" name="cuidad" class="form-control"
                       value="{{ old('cuidad') ?? $garante->cuidad }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="provincia" name="provincia" class="form-control"
                       value="{{ old('provincia') ?? $garante->provincia }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="barrio" name="barrio" class="form-control"
                       value="{{ old('barrio') ?? $garante->barrio }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="codigo_postal" name="codigo_postal" class="form-control"
                       value="{{ old('codigo_postal') ?? $garante->codigo_postal }}">
                <div class="form-text">Sin puntos, comas y guiones.</div>
            </div>
                        ...
                        <select name="prefijo_telefonico_fk_id" id="prefijo_telefonico_fk_id" class="form-control">
                            @foreach($prefijosTelefonicos as $prefijo)
                                <option
                                    ...
                                    @selected(old('prefijo_telefonico_fk_id', $garante->prefijo_telefonico_fk_id) == $prefijo->prefijo_telefonico_id)>
                ...
                <div class="col-2">
                    <div class="mb-3">
                        ...
                        <input type="text" id="codigo_de_area" name="codigo_de_area" class="form-control"
                               value="{{ old('codigo_de_area') ?? $garante->codigo_de_area }}">
                    </div>
                </div>
                <div class="col-8">
                    <div class="mb-3">
                        ...
                        <input type="text" id="numero_de_telefono" name="numero_de_telefono" class="form-control"
                               value="{{ old('numero_de_telefono') ?? $garante->numero_de_telefono }}">
                        <div class="form-text">Sin puntos, comas y guiones.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="fecha_de_nacimiento" name="fecha_de_nacimiento" class="form-control"
                       value="{{ old('fecha_de_nacimiento') ?? $garante->fecha_de_nacimiento }}">
            </div>

            <div class="mb-3">
                <button type="submit" class="btn btn-primary w-100">Editar Garante</button>
            </div>
        </form>
    </section>
@endsection
