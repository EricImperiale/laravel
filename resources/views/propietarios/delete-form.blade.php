...
@section('main')
    <section>
        ...
        <form action="{{ route('propietarios.processDelete', ['id' => $propietario->propietario_id]) }}" method="post"
            ...
            <div class="mb-3">
                ...
                <input type="text" id="altura" name="altura" class="form-control" disabled
                       value="{{ old('altura', $propietario->altura) }}">
            </div>
                ...
                <div class="col-8">
                    <div class="mb-3">
                        ...
                        <input type="text" id="numero_de_telefono" name="numero_de_telefono" class="form-control"
                               disabled value="{{ old('numero_de_telefono', $propietario->numero_de_telefono) }}">
                        <div class="form-text">Sin puntos, comas y guiones.</div>
                    </div>
                </div>
            </div>
